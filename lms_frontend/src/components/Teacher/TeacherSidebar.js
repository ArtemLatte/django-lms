    ...
    return (
        <div className="card">
            <div className="list-group list-group-flush">
                ...
                <Link to="/quiz" className="list-group-item list-group-item-action">Список квизов</Link>
                <Link to="/add-quiz" className="list-group-item list-group-item-action">Создать квиз</Link>
