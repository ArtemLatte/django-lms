        ...
        <div className="container mt-4">
            <div className="row">
                ...
                <div className="col-md-9">
                    <div  className='card'>
                        <h5 className='card-header'>Добавить учебный материал</h5>
                        <div className='card-body'>
                            ...
                            <div className="mb-3">
                                    <label for="upload" className="form-label">Файл</label>
                                    <input type="file" id="upload" onChange={handleFileChange} name='upload' className="form-control" />
                            </div>
                            <div className="mb-3">
                                    <label for="remarks" className="form-label">Замечания</label>
